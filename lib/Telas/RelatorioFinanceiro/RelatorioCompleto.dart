...
class RelatorioCompleto extends StatefulWidget {
  String _uid;
  RelatorioCompleto(this._uid);
  @override
  _RelatorioCompletoLogica createState() => _RelatorioCompletoLogica();
}

class _RelatorioCompletoLogica extends State<RelatorioCompleto>{
  List<String> retorno;
  _definirRetorno()async{
    List<String> retornoAux =await GerarRelatorioFinanceiro.chamarPropostas(widget._uid,0);
    setState(() {
      retorno=retornoAux;
    });
  }
  ...
  @override
  Widget build(BuildContext context) => _RelatorioCompletoTela(this);
}

class _RelatorioCompletoTela extends WidgetView<RelatorioCompleto, _RelatorioCompletoLogica> {
  _RelatorioCompletoTela(_RelatorioCompletoLogica state): super(state);
